# Básicamente, aprovechamos el entorno del lenguaje C para
# obtener las dependencias y librerías necesarias para Ocaml

# Ejemplo: https://github.com/mlin/forkwork
